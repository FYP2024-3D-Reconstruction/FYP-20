...
class Cameras(TensorDataclass):
    ...
    def __init__(
        ...
        camera_extent : Optional[Float[Tensor, "num_cameras"]] = torch.tensor(1.0), #Changed this to from none to this float tensor
        batch_size:Optional[Int[Tensor, "num_cameras 1"]] = None  # Changed this code, Previously it was like ||| batch_size:Optional[Int] = 1 |||
    ) -> None:
